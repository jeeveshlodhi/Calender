...
import { FaAngleLeft, FaAngleRight, FaSearch, FaRegCalendarAlt } from "react-icons/fa";
import profile from "../assets/avatar_female.png";
import GlobalContext from "../context/GlobalContext";
import axios from 'axios';

const Header = () => {
    const { monthIndex, setMonthIndex, isLogin, setLogin, loginEmail, setLoginEmail } =
    ...
    useEffect(()=>{
        ...
        if(checkLogin === 'true'){
            ...
            axios.get('http://127.0.0.1:3000/api/checkName?email=' + checkEmail).then((res)=>{
    ...
    const validateLogin = (e) => {
        ...
        try{
            console.log(user)
            let url = "http://127.0.0.1:3000/api/checkLogin?email=" + email+"&password=" + password
            let checkUrl = 'http://127.0.0.1:3000/api/checkUser?email='+ email
            console.log(url)
            axios.get(checkUrl).then((res)=>{
